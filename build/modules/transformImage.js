...
function resize(inputPath, outputPath, format, width, height) {
    return __awaiter(this, void 0, void 0, function () {
        var readStream, writeStream, transform;
        return __generator(this, function (_a) {
            readStream = fs_1.default.createReadStream(inputPath);
            writeStream = fs_1.default.createWriteStream(outputPath);
